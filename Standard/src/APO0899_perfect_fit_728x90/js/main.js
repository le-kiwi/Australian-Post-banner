...
function frame1(){
   ...
   .from(the, 0.6, {top:"-=300", ease:Power2.easeOut}, "-=0.1")
   ...
   .to(parcelContainer, 0.5, {top:55}, "parcelIn")
   .set({},{}, "+=1")
   return tl;
...
function frame2(){
    ...
    tl.add("intro")
    .to(parcelContainer, 0.7, {top:-106, ease:Power1.easeOut}, "intro")
    .fromTo(imageContainer, .5, { clip:"rect(0px 728px 90px 0px)" }, { clip:"rect(0px 728px 0px 0px)" },"-=0.8")
    .set({},{}, "+=0.3")
    return tl;
}
...
function frame3(){
    ...
    tl.to(parcelContainer, 0.5, {left:600, ease:Back.easeIn})
    .add("intro", "-=0.1")
    ...
    .to(text02, 0.6, {top:90, ease:Back.easeIn}, "introOut")
...
function frame4(){
    ...
    .from(text04, 0.6, {top:-90, ease:Power1.easeOut}, "-=0.3")
    .set({},{}, "+=1.4")
    .add("cta")
...
function createMasterTimeline() {
  ...
  timeline = new TimelineMax();
    timeline.add(frame1(), "0.15") // add the first animation at a time of 0.3 seconds
    .add(frame2())
    .add(frame3())
    .add(frame4());
