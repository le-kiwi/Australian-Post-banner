...
function frame1(){
   ...
   .to(parcelContainer, 0.5, {top:19}, "parcelIn")
   .set({},{}, "+=0.7")
   return tl;
...
function frame2(){
    ...
    tl.add("intro")
    .to(parcelContainer, 0.7, {top:-92, ease:Power1.easeOut}, "intro")
    .fromTo(imageContainer, .5, { clip:"rect(0px 320px 50px 0px)" }, { clip:"rect(0px 320px 0px 0px)" },"-=0.8")
    .set({},{}, "+=.7")
    return tl;
}
...
function frame3(){
    ...
    tl.to(parcelContainer, 0.6, {top:-260, ease:Power1.easeOut})
    .add("intro", "-=0.2")
...
function frame4(){
    ...
    .set({},{}, "+=1.4")
    .add("removeCopy")
    .to(text03, 0.4, {autoAlpha:0}, "removeCopy")
    .to(text04, 0.4, {autoAlpha:0}, "removeCopy")
    .add("cta")
