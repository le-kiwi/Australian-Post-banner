...
function frame1(){
   ...
   .add("parcelIn")
   .from(parcelContainer, 0.8, {scaleX:1, scaleY:1, ease:Power1.easeOut}, "parcelIn")
   .to(parcelContainer, 0.6, {top:110, ease:Back.easeOut}, "parcelIn")
   .set({},{}, "+=1")
   return tl;
...
function frame2(){
    ...
    tl.add("intro")
    .to(parcelContainer, 0.6, {top:0, ease:Power1.easeOut}, "intro")
    
    .fromTo(imageContainer, 1.5, { clip:"rect(0px 300px 600px 0px)" }, { clip:"rect(0px 300px 0px 0px)" },"-=1")
    .to(parcelOpen, 0.2, {height:0}, "-=1")
    //.to(parcelContainer, 0.2, {scaleX:1.15, scaleY:1.15}, "-=.7")
    //.to(parcelContainer, 0.3, {scaleX:1, scaleY:1, ease:Power1.easeOut}, "-=.6")
    .set({},{}, "+=0.3")
    return tl;
}
...
function frame3(){
    ...
    tl.to(parcelContainer, 0.5, {left:300, ease:Back.easeIn})
    .add("intro", "-=0.2")
...
function createMasterTimeline() {
  ...
  timeline = new TimelineMax();
    timeline.add(frame1(), "0.05") // add the first animation at a time of 0.3 seconds
    .add(frame2())
    .add(frame3())
    .add(frame4());
